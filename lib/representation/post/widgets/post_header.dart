  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (content, _) {
        return Row(
          children: [
            // Avatar - load từ database hoặc placeholder
            CircleAvatar(
              radius: 24,
              backgroundImage: controller.currentUser?.avatarUrl != null
              ...
              child: Column(
                ...
                children: [
                  Wrap(
                    ...
                    children: [
                      // Tên user - load từ database
                      Text(
                        controller.currentUser?.name ?? 'Nguyễn Văn A',
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(
                            controller.selectedPrivacy == 'PUBLIC'
                                ? Icons.public
                                : Icons.lock,
                            size: 12,
                            color: Colors.grey,
